...
namespace Prj_Soft_Protection
{
    ...
    public partial class ProtectionModeWindow : Window
    {
        ...
        {
            TimeStops.Clear();
            Data = new StreamReader(@"C:\Users\Микита\OneDrive\Рабочий стол\00\Pr1\Data.txt");
            DataText = "";
            ...
            if (DataText == "")
            {
                MessageBox.Show("Файл пустий! Задайте еталонні параметри!");
            }
            Data.Close();
        }
        ...
        private void CheckUser()
        {
            ...
            if (CurUserRows != 0 && AdminRows != 0)
            {
                ...
                var Writer = new StreamWriter(@"C:\Users\Микита\OneDrive\Рабочий стол\00\Pr1\Data.txt");
                ...
                MessageBox.Show("Недостатньо даних для перевірки!");
        }
